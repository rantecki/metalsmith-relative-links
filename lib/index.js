 ...
 * @property {module:metalsmith-plugin-kit~matchList} [match] Defaults to match all files.
 * @property {module:metalsmith-plugin-kit~matchOptions} [matchOptions={}] Additional options for matching files.
